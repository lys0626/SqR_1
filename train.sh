...
# 输出目录
OUTPUT_DIR="./experiment/${DATANAME}_${HIDDEN_DIM}_${DIM_FEEDFORWARD}_${OPTIM}_${LR}_${DEC_LAYERS}_3_1_${NHEADS}_${BATCH_SIZE}_${SCHEDULER}_${WD}_${SPLICEMIX_START_EPOCH}"
